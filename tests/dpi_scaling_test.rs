...
-> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    base_plot
        .clone()
        .dpi(96)
        .save("generated/tests/render/dpi_scaling_96_test.png")?; // Screen
    base_plot
        .clone()
        .dpi(150)
        .save("generated/tests/render/dpi_scaling_150_test.png")?; // Web
    base_plot
        .clone()
        .dpi(300)
        .save("generated/tests/render/dpi_scaling_300_test.png")?; // Print
    base_plot
        .clone()
        .dpi(600)
        .save("generated/tests/render/dpi_scaling_600_test.png")?; // IEEE

    // Get file sizes
    let size_96 = fs::metadata("generated/tests/render/dpi_scaling_96_test.png")?.len();
    let size_150 = fs::metadata("generated/tests/render/dpi_scaling_150_test.png")?.len();
    let size_300 = fs::metadata("generated/tests/render/dpi_scaling_300_test.png")?.len();
    let size_600 = fs::metadata("generated/tests/render/dpi_scaling_600_test.png")?.len();
...
fn test_dpi_canvas_size_scaling() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    plot.clone()
        .dpi(96)
        .save("generated/tests/render/canvas_96_test.png")?;
    plot.clone()
        .dpi(192)
        .save("generated/tests/render/canvas_192_test.png")?;
    plot.clone()
        .dpi(288)
        .save("generated/tests/render/canvas_288_test.png")?;

    let size_96 = fs::metadata("generated/tests/render/canvas_96_test.png")?.len();
    let size_192 = fs::metadata("generated/tests/render/canvas_192_test.png")?.len();
    let size_288 = fs::metadata("generated/tests/render/canvas_288_test.png")?.len();
...
fn test_dpi_font_scaling_consistency() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    plot.clone()
        .dpi(96)
        .save("generated/tests/render/font_96_test.png")?;
    plot.clone()
        .dpi(300)
        .save("generated/tests/render/font_300_test.png")?;

    let size_96 = fs::metadata("generated/tests/render/font_96_test.png")?.len();
    let size_300 = fs::metadata("generated/tests/render/font_300_test.png")?.len();
