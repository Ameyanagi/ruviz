...
fn test_vec_f64() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("Vec<f64> Data")
        .save("generated/tests/render/data_vec_f64.png");
...
fn test_vec_f32() {
    ...
    let result = Plot::new()
        .line(&x_f64, &y_f64)
        .title("Vec<f32> Data")
        .save("generated/tests/render/data_vec_f32.png");
...
fn test_slice_f64() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("Slice Data")
        .save("generated/tests/render/data_slice.png");
...
fn test_integer_data() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("Integer Data")
        .save("generated/tests/render/data_integer.png");
...
fn test_ndarray_data() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("ndarray Data")
        .save("generated/tests/render/data_ndarray.png");
...
fn test_string_categories() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_string_categories.png");
...
fn test_str_slice_categories() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_str_categories.png");
...
fn test_empty_data_error() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .save("generated/tests/render/data_should_not_exist.png");
...
fn test_mismatched_length_error() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .save("generated/tests/render/data_should_not_exist_2.png");
...
fn test_single_point() {
    ...
    let result = Plot::new()
        ...
        .marker_size(10.0)
        .title("Single Point")
        .save("generated/tests/render/data_single_point.png");
...
fn test_two_points() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("Two Points")
        .save("generated/tests/render/data_two_points.png");
...
fn test_large_values() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("Large Values")
        .save("generated/tests/render/data_large_values.png");
...
fn test_small_values() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("Small Values")
        .save("generated/tests/render/data_small_values.png");
...
fn test_negative_values() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_negative_values.png");
...
fn test_zero_values() {
    ...
    let result = Plot::new()
        ...
        .marker(MarkerStyle::Circle)
        .title("Zero X Values")
        .save("generated/tests/render/data_zero_x.png");
...
fn test_constant_values() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_constant_y.png");
...
fn test_nan_handling() {
    ...
    let result = Plot::new()
        .line(&x, &y)
        .title("NaN Handling")
        .save("generated/tests/render/data_nan.png");
...
fn test_infinity_handling() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_infinity.png");
...
fn test_unicode_categories() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_unicode_categories.png");
...
fn test_long_categories() {
    ...
    let result = Plot::new()
        ...
        .save("generated/tests/render/data_long_categories.png");
