...
The API reference pages are generated from the exported TypeScript surface with TypeDoc.
...
Run `bun run --cwd packages/ruviz docs:api` to regenerate the markdown
