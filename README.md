...
- [Latest Release Notes (v0.4.9)](docs/releases/v0.4.9.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.9", features = ["animation"] }
```
...
**Status**: v0.4.9 - Early development, API may change. Production use at your own risk.
