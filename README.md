...
- [Latest Release Notes (v0.4.7)](docs/releases/v0.4.7.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.7", features = ["animation"] }
```
...
**Status**: v0.4.7 - Early development, API may change. Production use at your own risk.
