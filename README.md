...
- [Latest Release Notes (v0.4.5)](docs/releases/v0.4.5.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.5", features = ["animation"] }
```
...
**Status**: v0.4.5 - Early development, API may change. Production use at your own risk.
