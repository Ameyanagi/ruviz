...
- [Latest Release Notes (v0.4.6)](docs/releases/v0.4.6.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.6", features = ["animation"] }
```
...
**Status**: v0.4.6 - Early development, API may change. Production use at your own risk.
