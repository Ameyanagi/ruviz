...
- [Latest Release Notes (v0.3.3)](docs/releases/v0.3.3.md)
...
```toml
[dependencies]
ruviz = { version = "0.3.3", features = ["parallel", "simd"] }
```
...
```toml
[dependencies]
ruviz = { version = "0.3.3", features = ["typst-math"] }
```
...
```toml
[dependencies]
ruviz = { version = "0.3.3", features = ["animation"] }
```
...
**Status**: v0.3.3 - Early development, API may change. Production use at your own risk.
