...
- [Latest Release Notes (v0.4.10)](docs/releases/v0.4.10.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.10", features = ["animation"] }
```
...
**Status**: v0.4.10 - Early development, API may change. Production use at your own risk.
