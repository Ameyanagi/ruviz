...
- [Latest Release Notes (v0.4.1)](docs/releases/v0.4.1.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.1", features = ["animation"] }
```
...
**Status**: v0.4.1 - Early development, API may change. Production use at your own risk.
