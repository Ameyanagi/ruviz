...
- [Latest Release Notes (v0.4.8)](docs/releases/v0.4.8.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.8", features = ["animation"] }
```
...
**Status**: v0.4.8 - Early development, API may change. Production use at your own risk.
