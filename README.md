...
- [Latest Release Notes (v0.4.11)](docs/releases/v0.4.11.md)
...
```toml
[dependencies]
ruviz = { version = "0.4.11", features = ["animation"] }
```
...
**Status**: v0.4.11 - Early development, API may change. Production use at your own risk.
