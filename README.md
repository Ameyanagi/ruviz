...
- [Latest Release Notes (v0.3.0)](docs/releases/v0.3.0.md)
...
```toml
[dependencies]
ruviz = { version = "0.3.0", features = ["animation"] }
```
...
**Status**: v0.3.0 - Early development, API may change. Production use at your own risk.
