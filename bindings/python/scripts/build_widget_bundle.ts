...
const entryPath = resolve(repoRoot, "packages", "ruviz", "src", "python-widget.ts");
const outPath = resolve(repoRoot, "bindings", "python", "ruviz_py", "ruviz", "widget.js");
...
const banner = [
  "// Generated by bindings/python/scripts/build_widget_bundle.ts.",
  "// Do not edit this file directly; edit packages/ruviz/src/python-widget.ts instead.",
  "",
].join("\n");
