...
```toml
[dependencies]
ruviz = { version = "0.4.14", features = ["parallel"] }
```
...
```toml
[dependencies]
ruviz = { version = "0.4.14", features = ["parallel", "simd"] }
```
...
```toml
[dependencies]
ruviz = { version = "0.4.14", features = ["gpu"] }
```
...
```toml
[dependencies]
ruviz = { version = "0.4.14", features = ["interactive"] }
