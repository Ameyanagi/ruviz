...
for a minimal component-wiring example. On Linux and Windows, embed the plot in
your existing GPUI application bootstrap rather than relying on the example
launcher helper.
