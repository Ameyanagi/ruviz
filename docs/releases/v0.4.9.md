...
- `cd bindings/python && uv run python -m pytest tests/test_api.py -k 'large_plot'`
- `bun run --cwd apps/web-demo test:e2e --grep "python widget bundle renders representative large snapshots without blacking out"`
